...
// //     if (!portfolioData)
// //       return <div className="p-10 text-center">Portfolio not found.</div>;
...
// //       description:
// //         "Developed and maintained client-facing applications, collaborated with senior developers to implement new features.",
...
// //       description:
// //         "Assisted in building RESTful APIs, performed code reviews, and participated in agile development processes.",
...
// //                 <p className={`text-xl mt-2 ${currentTheme.accentColor}`}>
// //                   {aboutData.title}
// //                 </p>
...
// //                     className={`${currentTheme.accentColor} hover:opacity-75`}
// //                   >
// //                     <Github size={20} />
// //                   </a>
// //                   <a
...
// //             <div>
// //               <h2
// //                 className={`text-2xl font-semibold mb-4 ${currentTheme.textColor}`}
// //               >
// //                 About Me
// //               </h2>
...
// //                 <div
// //                   key={project.id}
// //                   className={`${currentTheme.cardBgColor} rounded-lg shadow-md overflow-hidden`}
// //                 >
// //                   <img
...
// //                   <div className="p-4">
// //                     <h3
// //                       className={`text-xl font-semibold ${currentTheme.textColor}`}
// //                     >
// //                       {project.title}
// //                     </h3>
...
// //                         <span
// //                           key={index}
// //                           className={`px-2 py-1 ${currentTheme.secondaryColor} ${currentTheme.textColor} text-sm rounded`}
// //                         >
// //                           {tech}
// //                         </span>
// //                       ))}
...
// //                           target="_blank"
// //                           rel="noopener noreferrer"
// //                           className={`flex items-center gap-1 ${currentTheme.accentColor} hover:opacity-75`}
// //                         >
// //                           <Github size={16} /> Code
// //                         </a>
// //                       )}
...
// //                 <div
// //                   key={internship.id}
// //                   className={`${currentTheme.cardBgColor} rounded-lg shadow-md p-6`}
// //                 >
// //                   <h3
// //                     className={`text-xl font-semibold ${currentTheme.textColor}`}
// //                   >
...
// //                 <div key={index}>
// //                   <h3
// //                     className={`text-xl font-semibold mb-3 ${currentTheme.textColor}`}
// //                   >
// //                     {category.category}
// //                   </h3>
...
// //             )} */}
// //             <div
// //               className={`absolute right-0 mt-2 ${currentTheme.cardBgColor} ${currentTheme.cardTextColor} border rounded shadow z-20`}
// //             >
// //               {themes.map((theme) => (
// //                 <button
// //                   key={theme.id}
...
// //             <nav
// //               className={`${currentTheme.cardBgColor} shadow-md rounded-lg p-4 sticky top-8`}
// //             >
...
// //           {/* Content area */}
// //           <div
// //             className={`flex-1 ${currentTheme.cardBgColor} shadow-md rounded-lg p-6`}
// //           >
// //             {renderSection()}
// //           </div>
// //         </div>
...
// //             <div>
// //               <p
// //                 className={`text-lg font-semibold ${currentTheme.footerTextColor}`}
// //               >
// //                 {aboutData.name}
// //               </p>
...
//     year: project.year,
//     technologies: [], // Add if backend includes it
//     githubUrl: "",
//     liveUrl: "",
//     imageUrl: "/api/placeholder/400/250",
//   })) || [];
...
//     {
//       category: "Skills",
//       skills: data.skills?.map((skill) => skill.skillName) || [],
//     },
//   ];
...
//     {
//       id: 1,
//       degree: data.educationDegreeName,
//       field: "Computer Science and Engineering",
//       duration: data.educationYear,
//       gpa: data.educationCgpa,
...
//             </div>
//             <div>
//               <h2 className={`text-2xl font-semibold mb-4 ${currentTheme.textColor}`}>
//                 About Me
//               </h2>
//               <p className="leading-relaxed text-gray-700 dark:text-gray-300">
//                 {aboutData.bio}
...
//                   />
//                   <div className="p-4">
//                     <h3 className={`text-xl font-semibold ${currentTheme.textColor}`}>
//                       {project.title}
//                     </h3>
//                     <p className="mt-2 text-gray-600 dark:text-gray-300">
//                       {project.description}
...
//               {techStackData.map((category, index) => (
//                 <div key={index}>
//                   <h3 className={`text-xl font-semibold mb-3 ${currentTheme.textColor}`}>
//                     {category.category}
//                   </h3>
//                   <div className="flex flex-wrap gap-3">
//                     {category.skills.map((skill, skillIndex) => (
...
//           <div className="flex flex-col items-center justify-between md:flex-row">
//             <div>
//               <p className={`text-lg font-semibold ${currentTheme.footerTextColor}`}>
//                 {aboutData.name}
//               </p>
//               <p className="text-gray-300">{aboutData.title}</p>
//             </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center gap-4 mt-4 md:justify-start flex-wrap">
                {aboutData.github && (
                  <a href={aboutData.github} target="_blank" rel="noreferrer">
                    <Github size={20} />
                  </a>
                ...
                {aboutData.whatsapp && (
                  <a
                    href={`https://wa.me/${aboutData.whatsapp}`}
                    target="_blank"
                    rel="noreferrer"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {projectsData.map((project) => (
                <div
                  key={project.id}
                  className={`${currentTheme.cardBgColor} rounded-lg shadow-md p-4`}
                >
                  <h3 className={`text-xl font-semibold ${currentTheme.textColor}`}>
  {project.title}
</h3>
